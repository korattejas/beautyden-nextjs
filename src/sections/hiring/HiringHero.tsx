...
import { HiBriefcase, HiSparkles } from "react-icons/hi2";
    ...
    <section className="pt-24 pb-16 relative overflow-hidden bg-gradient-to-br from-primary/10 to-secondary/10">
      ...
      <Container>
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            Join BeautyDen and be part of revolutionizing the beauty industry.
            We offer exciting opportunities for passionate beauty professionals.
          </motion.p>
        </div>
      </Container>
    </section>
