...
import { HiCheckCircle, HiSparkles, HiHeart, HiPhone, HiEnvelope } from "react-icons/hi2";
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-sm text-foreground/60 text-center">+91 95747 58282</p>
              </motion.a>
              ...
              >
                ...
                <p className="text-sm text-foreground/60 text-center">contact@beautyden.com</p>
              </motion.a>
